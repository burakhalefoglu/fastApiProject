...
from core.libraries.investpy.utils import constant as cst
...
def funds_as_df(country=None):
    ...
    if funds is None:
        raise IOError("ERR#0005: clients_funds not found or unable to retrieve.")
...
def fund_countries_as_list():
    """
    This function returns a listing with all the available countries from where clients_funds can be retrieved, so to
