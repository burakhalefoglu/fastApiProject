...
from core.libraries.investpy.data.currency_crosses_data import (
...
def get_currency_cross_recent_data(
    ...
    Examples:
        >>> data = get_currency_cross_recent_data(currency_cross='EUR/USD')
        >>> data.head()
    ...
    currency_crosses = get_resources_by_file_name("currency_crosses.csv")
...
def get_currency_cross_historical_data(
    ...
    Examples:
        >>> data = get_currency_cross_historical_data(currency_cross='EUR/USD', from_date='01/01/2018', to_date='01/01/2019')
        >>> data.head()
                      Open    High     Low   Close Currency
        Date
...
def get_currency_crosses_overview(currency, as_json=False, n_results=100):
    ...
    table = root_.xpath(".//table[@deposit_id='cr1']/tbody/tr")
...
def search_currency_crosses(by, value):
    ...
    currency_crosses.drop(columns=["tag", "deposit_id"], inplace=True)
