...
setup(
    ...
    install_requires=requirements(filename='core/libraries/investpy/requirements/requirements.txt'),
    ...
    python_requires='>=3.7',
    extras_require={
        "tests": requirements(filename='core/libraries/investpy/requirements/tests-requirements.txt'),
        "docs": requirements(filename='core/libraries/investpy/requirements/docs-requirements.txt')
    },
    keywords=', '.join([
        'investing', 'investing-api', 'historical-data',
        'financial-data', 'stocks', 'clients_funds', 'etfs',
