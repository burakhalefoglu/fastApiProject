...
from core.libraries.investpy.data.etfs_data import (
...
def get_etf_recent_data(
    ...
    Examples:
        >>> data = get_etf_recent_data(etf='bbva accion dj eurostoxx 50', country='spain')
        >>> data.head()
    ...
    etfs = get_resources_by_file_name("etfs.csv")
...
def get_etf_historical_data(
    ...
    Examples:
        >>> data = get_etf_historical_data(etf='bbva accion dj eurostoxx 50', country='spain', from_date='01/01/2010', to_date='01/01/2019')
        >>> data.head()
                     Open   High    Low  Close  Volume Currency Exchange
        Date
...
def search_etfs(by, value):
    ...
    etfs.drop(columns=["tag", "deposit_id"], inplace=True)
