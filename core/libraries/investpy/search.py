...
from core.libraries.investpy.utils.constant import COUNTRY_FILTERS, FLAG_FILTERS, PAIR_FILTERS, PRODUCT_FILTERS
from core.libraries.investpy.utils.extra import random_user_agent
from core.libraries.investpy.utils.search_obj import SearchObj
...
def search_quotes(text, products=None, countries=None, n_results=None):
    ...
    Args:
        ...
        products (:obj:`list` of :obj:`str`, optional):
            ...
            the filters. Possible products are: `indices`, `stocks`, `etfs`, `clients_funds`, `commodities`, `currencies`,
    ...
    while True:
        ...
        for event in events:
            ...
            if importances is not None:
                if event["pair_type"] not in importances:
                    continue

            if countries is not None:
                if event["flag"] not in countries:
                    continue
